...
const Contact = () => {
  return (
    <div id="contact" className="sm:mt-32 md:mt-52">
      <div className="sm:max-w-96 md:max-w-[50rem] lg:max-w-[62rem] mx-auto flex items-center md:justify-between sm:flex-col md:flex-row gap-3 rounded-3xl bg-gradient-to-r from-emerald-400 to-sky-400 py-8 md:px-8">
        <div className="flex items-center md:items-start justify-center flex-col sm:gap-3 md:gap-5 sm:text-center md:text-start text-black">
          ...
          <p className="sm:max-w-72 md:max-w-[32rem] lg:max-w-[44rem] md:text-2xl">
        ...
        <button className="md:min-w-[150px] flex items-center gap-2 bg-black text-white px-6 py-4 text-xs md:text-xl rounded-xl hover:-translate-y-1 transition-transform group">
          Contact me
          <Arrow className="sm:h-3 md:h-5 w-auto group-hover:rotate-45 transition-transform" />
        </button>
      </div>
    </div>
  );
